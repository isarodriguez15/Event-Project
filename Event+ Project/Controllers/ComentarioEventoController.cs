...
namespace EventPlus_.Controller
{
    ...
    public class ComentarioEventoController : ControllerBase
    {
        ...
        public IActionResult Get(Guid id)
        {
            try
            {
                List<ComentarioEvento> listaComentarioEvento = _comentarioEventoRepository.Listar(id);
        ...
        public IActionResult GetById(Guid UsuarioID, Guid EventoID)
        {
            try
            {
                ComentarioEvento novoComentarioEvento = _comentarioEventoRepository.BuscarIdUsuario(UsuarioID, EventoID);
